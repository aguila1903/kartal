...
if (isset($_REQUEST["trainer"])) {
    $trainer = trim($_REQUEST["trainer"]);
    $trainer = sonderzeichen($trainer);
} else {
...
if (isset($_REQUEST["trainer_id"])) {
    if ($_REQUEST["trainer_id"] != "null" && $_REQUEST["trainer_id"] != "") {
...
get_image("http://www.weltfussball.de/spieler_profil/$trainer/", "spieler", $trainer, "tr", "fr", $trainer_id);
